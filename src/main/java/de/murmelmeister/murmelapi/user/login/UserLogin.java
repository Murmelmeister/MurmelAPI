...
/**
 * Represents a user login record, including login and logout times, IP address, client version, and protocol version.
 ...
 * @param clientVersion   Version of the client used for login
