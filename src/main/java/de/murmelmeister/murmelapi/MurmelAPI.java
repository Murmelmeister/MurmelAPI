...
public final class MurmelAPI {
    ...
    public MurmelAPI(Database database, Long fetchLimit, long cacheCapacity, Duration refreshInterval) {
        ...
        this.punishAuditProvider = PunishmentAuditProvider.of(database, gson, refreshProvider, fetchLimit, cacheCapacity, refreshInterval);
        ...
        this.maintenanceProvider = MaintenanceProvider.of(database, gson, refreshProvider, fetchLimit, cacheCapacity, refreshInterval);
