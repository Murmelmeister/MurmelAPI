...
public record Group(int id, String groupName, String teamTagId, int priority, boolean isDefault, int createdBy,
                    LocalDateTime createdAt, Integer changedBy, LocalDateTime changedAt) {


    public Group withUpdateMeta(String groupName, String teamTagId, Integer priority,
                                Integer changedBy, LocalDateTime changedAt) {
        return new Group(id,
                groupName != null ? groupName : this.groupName,
                teamTagId != null ? teamTagId : this.teamTagId,
