...
public final class GroupColorSettingsProvider implements GroupColorSettings {
    ...
    private enum Procedure {
        ...
        GROUP_COLOR_SETTINGS_INSERT("GroupColorSettings_Insert", "gid INT, creator INT, time BIGINT(255), " +
        ...
        GROUP_COLOR_SETTINGS_UPDATE_CHAT_PREFIX("GroupColorSettings_Update_ChatPrefix", "gid INT, creator INT, time BIGINT(255), chat VARCHAR(300)", "UPDATE [TABLE] SET ChatPrefix=chat, CreatorID=creator, EditedTime=time WHERE GroupID=gid;"),
        GROUP_COLOR_SETTINGS_UPDATE_CHAT_SUFFIX("GroupColorSettings_Update_ChatSuffix", "gid INT, creator INT, time BIGINT(255), chat VARCHAR(300)", "UPDATE [TABLE] SET ChatSuffix=chat, CreatorID=creator, EditedTime=time WHERE GroupID=gid;"),
        GROUP_COLOR_SETTINGS_UPDATE_CHAT_COLOR("GroupColorSettings_Update_ChatColor", "gid INT, creator INT, time BIGINT(255), chat VARCHAR(30)", "UPDATE [TABLE] SET ChatColor=chat, CreatorID=creator, EditedTime=time WHERE GroupID=gid;"),
        GROUP_COLOR_SETTINGS_UPDATE_TAB_PREFIX("GroupColorSettings_Update_TabPrefix", "gid INT, creator INT, time BIGINT(255), tab VARCHAR(300)", "UPDATE [TABLE] SET TabPrefix=tab, CreatorID=creator, EditedTime=time WHERE GroupID=gid;"),
        GROUP_COLOR_SETTINGS_UPDATE_TAB_SUFFIX("GroupColorSettings_Update_TabSuffix", "gid INT, creator INT, time BIGINT(255), tab VARCHAR(300)", "UPDATE [TABLE] SET TabSuffix=tab, CreatorID=creator, EditedTime=time WHERE GroupID=gid;"),
        GROUP_COLOR_SETTINGS_UPDATE_TAB_COLOR("GroupColorSettings_Update_TabColor", "gid INT, creator INT, time BIGINT(255), tab VARCHAR(30)", "UPDATE [TABLE] SET TabColor=tab, CreatorID=creator, EditedTime=time WHERE GroupID=gid;"),
        GROUP_COLOR_SETTINGS_UPDATE_TAG_PREFIX("GroupColorSettings_Update_TagPrefix", "gid INT, creator INT, time BIGINT(255), tag VARCHAR(300)", "UPDATE [TABLE] SET TagPrefix=tag, CreatorID=creator, EditedTime=time WHERE GroupID=gid;"),
        GROUP_COLOR_SETTINGS_UPDATE_TAG_SUFFIX("GroupColorSettings_Update_TagSuffix", "gid INT, creator INT, time BIGINT(255), tag VARCHAR(300)", "UPDATE [TABLE] SET TagSuffix=tag, CreatorID=creator, EditedTime=time WHERE GroupID=gid;"),
        GROUP_COLOR_SETTINGS_UPDATE_TAG_COLOR("GroupColorSettings_Update_TagColor", "gid INT, creator INT, time BIGINT(255), tag VARCHAR(30)", "UPDATE [TABLE] SET TagColor=tag, CreatorID=creator, EditedTime=time WHERE GroupID=gid;");
