...
public final class GroupPermissionProvider implements GroupPermission {
    ...
    private void createTable() throws SQLException {
        Database.update("CREATE TABLE IF NOT EXISTS %s (GroupID INT PRIMARY KEY, FOREIGN KEY (GroupID) REFERENCES Groups(ID), CreatorID INT, FOREIGN KEY (CreatorID) REFERENCES User(ID), Permission VARCHAR(1000), CreatedTime BIGINT(255), ExpiredTime BIGINT(255))", TABLE_NAME);
    }
